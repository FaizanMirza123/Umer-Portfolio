  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        ...
        isScrolled
          ? "bg-white/90 dark:bg-gray-900/90 backdrop-blur-md shadow-2xl border-b border-white/20 dark:border-gray-700/20"
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-8">
            ...
            >
              ...
              <Sparkles
                className="absolute top-1 right-1 text-white/70 animate-pulse"
                size={12}
              />
            </div>
            ...
            <div className="hidden md:flex items-center space-x-2">
              ...
              >
                ...
                <div className="absolute inset-0 bg-teal-50 dark:bg-teal-900/30 rounded-lg scale-0 group-hover:scale-100 transition-transform duration-300 opacity-0 group-hover:opacity-100"></div>
              </button>
              <button
