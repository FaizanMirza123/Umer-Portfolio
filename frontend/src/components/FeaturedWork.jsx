...
const FeaturedWork = ({ projects }) => {
  if (!projects || projects.length === 0) {
    return (
      <section className="py-16 bg-gray-900 dark:bg-black w-full transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {projects.slice(0, 3).map((project, index) => (
            <div
              key={index}
              className="bg-gray-800 dark:bg-gray-900 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              {/* Project Image */}
              ...
              <div className="p-4 sm:p-6">
                ...
                <p className="text-black-300 text-xs sm:text-sm mb-4 line-clamp-3">
                  {project.description}
                </p>
